...
TransactionBuilder.prototype.setVersionGroupId = function (versionGroupId) {
  if (!(coins.isZcashType(this.network) && this.tx.isOverwinterCompatible())) {
...
TransactionBuilder.prototype.setJoinSplits = function (transaction) {
  if (!(coins.isZcashType(this.network) && this.tx.supportsJoinSplits())) {
...
TransactionBuilder.fromTransaction = function (transaction, network) {
  ...
  if (coins.isZcashType(txbNetwork)) {
...
TransactionBuilder.prototype.sign = function (vin, keyPair, redeemScript, hashType, witnessValue, witnessScript) {
  ...
  } else if (coins.isZcashType(this.network)) {
